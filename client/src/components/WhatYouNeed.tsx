  ...
  const steps = [
    {
      ...
      descAr: 'سجل حساباً مجانياً في دقائق معدودة',
      descEn: 'Register a free account in minutes',
    },
    {
      icon: Mail,
      number: '2',
      ...
      descAr: 'فعّل حسابك عبر البريد الإلكتروني',
      descEn: 'Activate your account via email',
    },
    {
      icon: CreditCard,
      number: '3',
      titleAr: 'إضافة طريقة دفع',
      titleEn: 'Add Payment Method',
      descAr: 'أضف طريقة دفع آمنة لحسابك',
      descEn: 'Add a secure payment method to your account',
    },
    {
      icon: Rocket,
      number: '4',
      ...
      descAr: 'ابدأ البيع أو الشراء أو العمل الحر',
      descEn: 'Start selling, buying, or freelancing',
    },
  ];

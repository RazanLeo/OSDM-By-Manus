...
export default function ServiceDetails() {
  ...
  const { data: service, isLoading } = trpc.services.getById.useQuery({ id: parseInt(id!) });

  const handleOrderService = () => {
    toast.success(t('تم إضافة الطلب', 'Order added'));
  };
  ...
  const packages = [
    {
      ...
      features: [
        t('تصميم أساسي', 'Basic design'),
        t('مراجعة واحدة', 'One revision'),
        t('دعم لمدة أسبوع', 'One week support'),
      ],
    },
    {
      name: t('الباقة المتقدمة', 'Standard Package'),
      price: service.startingPrice * 2,
      deliveryTime: service.deliveryTime * 1.5,
      features: [
        t('تصميم متقدم', 'Advanced design'),
        t('3 مراجعات', '3 revisions'),
        t('دعم لمدة شهر', 'One month support'),
        t('ملفات المصدر', 'Source files'),
      ],
    },
    {
      name: t('الباقة المميزة', 'Premium Package'),
      price: service.startingPrice * 3,
      deliveryTime: service.deliveryTime * 2,
      features: [
        t('تصميم احترافي', 'Professional design'),
        t('مراجعات غير محدودة', 'Unlimited revisions'),
        t('دعم لمدة 3 أشهر', 'Three months support'),
        t('ملفات المصدر', 'Source files'),

...
export const wallets = mysqlTable("wallets", {
  ...
  escrowHeld: int("escrowHeld").default(0).notNull(),
...
export const disputes = mysqlTable("disputes", {
  ...
  orderId: int("orderId"),
  contractId: int("contractId"),
  disputeType: mysqlEnum("disputeType", ["service_order", "contract", "product_order"]).notNull(),
  ...
  counterpartyReply: text("counterpartyReply"),
